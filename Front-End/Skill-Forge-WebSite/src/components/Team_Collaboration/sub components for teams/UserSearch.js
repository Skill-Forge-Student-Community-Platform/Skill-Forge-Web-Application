...
const UserSearch = ({ teamId }) => {
    ...
    const { users, searchUsers, loading, error, openInviteModal, closeInviteModal, sendInvite, modalOpen, selectedUser } = useUserSearchStore();
    ...
    return (
        <div className="p-8 max-w-xl mx-auto bg-gradient-to-br from-white to-gray-50 dark:from-gray-900 dark:to-gray-800 rounded-xl shadow-xl border border-gray-100 dark:border-gray-700">
            <h2 className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 dark:from-blue-400 dark:to-indigo-400 mb-6 flex items-center">
                <svg className="w-6 h-6 mr-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
            ...
            {users.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-10 px-6 bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-inner">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 font-medium text-lg mb-1">No users found</p>
                    <p className="text-gray-500 dark:text-gray-400 text-center">Try a different search term</p>
                </div>
            ) : !loading && (
                <div className="flex flex-col items-center justify-center py-10 px-6 bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-700 shadow-inner">
                    <svg className="w-16 h-16 text-gray-300 dark:text-gray-600 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <p className="text-gray-700 dark:text-gray-300 font-medium text-lg mb-1">Search for users</p>
                    <p className="text-gray-500 dark:text-gray-400 text-center">Enter a name to find team members</p>
                </div>
            )}
