...
const LoginImagePattern = ({ title, subtitle, quote, quoteAuthor }) => {
  ...
  return (
    <div className="hidden lg:flex flex-col items-center justify-center h-screen bg-gradient-to-br from-gray-800 to-gray-900 p-12 border-r border-gray-700">
      <motion.div
      ...
      >
        <div className="grid grid-cols-3 gap-4 mt-11 mb-8">
          {[...Array(9)].map((_, i) => (
            <motion.div
              key={i}
        ...
        >
          ...
          {quote && (
            <motion.div
              ...
              className="mt-8 p-6 bg-gray-800/50 border border-gray-700/50 rounded-lg"
            >
